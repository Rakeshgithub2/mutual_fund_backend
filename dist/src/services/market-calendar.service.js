...
exports.MarketCalendarService = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const moment_timezone_1 = __importDefault(require("moment-timezone"));
// Market Calendar Schema
const marketCalendarSchema = new mongoose_1.default.Schema({
...
const MarketCalendar = mongoose_1.default.model('MarketCalendar', marketCalendarSchema);
class MarketCalendarService {
    ...
    static async getNextTradingDay(fromDate = new Date()) {
        let nextDay = (0, moment_timezone_1.default)(fromDate).add(1, 'day');
...
exports.MarketCalendarService = MarketCalendarService;
exports.default = MarketCalendarService;
