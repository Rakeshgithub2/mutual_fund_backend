...
async function seedKnowledgeBase() {
    try {
        ...
        const collection = mongodb_1.mongodb.getCollection('knowledge_base');
        // Clear existing data
        ...
        console.log(`📚 Inserting ${knowledge_base_1000_complete_1.knowledgeBase.length} knowledge entries...`);
