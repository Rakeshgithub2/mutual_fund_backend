        ...
        for (const fund of funds) {
            ...
            for (let i = 0; i < navRecords.length; i += batchSize) {
                ...
                try {
                    ...
                    console.log(`  Warning: Some records in batch ${Math.floor(i / batchSize) + 1} may already exist`);
                }
                console.log(`  Inserted batch ${Math.floor(i / batchSize) + 1}/${Math.ceil(navRecords.length / batchSize)}`);
            }
