...
const comprehensive_amfi_importer_1 = require("../services/importers/comprehensive-amfi.importer");
const mongodb_1 = require("../db/mongodb");
async function main() {
    console.log('╔════════════════════════════════════════════════════════════════╗');
    console.log('║   COMPREHENSIVE AMFI IMPORT - Indian Mutual Fund Universe     ║');
    ...
    try {
        ...
        // Create importer
        const importer = new comprehensive_amfi_importer_1.ComprehensiveAMFIImporter();
        // Run import
        ...
        console.log(`📊 Total Processed: ${result.fundsAdded + result.fundsUpdated + result.fundsSkipped}`);
