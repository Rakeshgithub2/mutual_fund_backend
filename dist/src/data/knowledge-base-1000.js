...
exports.knowledgeLevels1000 = exports.knowledgeCategories1000 = exports.knowledgeBase1000 = void 0;
exports.knowledgeBase1000 = [
    // =============================================
    ...
    },
    {
        ...
        definition: 'Mutual funds collect money, buy securities, and distribute returns to investors based on their units.',
        points: [
    ...
    },
    {
        ...
        definition: 'NAV (Net Asset Value) is the per-unit market value of a mutual fund.',
        points: [
    ...
    },
    {
        ...
        definition: 'SIP (Systematic Investment Plan) allows you to invest a fixed amount regularly in mutual funds.',
        points: [
    ...
    },
    {
        ...
        definition: 'SIP is better for regular investors; lump sum works when market is low and you have expertise.',
        points: [
    ...
    },
    {
        ...
        definition: 'Expense ratio is the annual fee charged by mutual fund for managing your money.',
        points: [
    ...
    },
    {
        ...
        definition: 'Exit load is a fee charged when you redeem/withdraw from a mutual fund before a specified period.',
        points: [
    ...
    },
    {
        ...
        definition: 'Direct plans have no distributor commission, resulting in lower expense ratio and higher returns.',
        points: [
    ...
    },
    {
        ...
        definition: 'ELSS (Equity Linked Savings Scheme) offers tax deduction under Section 80C with 3-year lock-in.',
        points: [
    ...
    },
    {
        ...
        definition: 'Active funds try to beat market through stock selection; passive funds simply track an index.',
        points: [
    ...
    // For brevity, I'll add key questions and you can expand further
    {
        ...
        definition: 'SIP returns are calculated using XIRR (Extended Internal Rate of Return) method.',
        points: [
    ...
    },
    {
        ...
        definition: 'Stocks are bought through a broker using a demat and trading account.',
        points: [
    ...
    },
    {
        ...
        definition: 'PE ratio (Price-to-Earnings) shows how much investors pay for each rupee of company earnings.',
        points: [
    ...
    // =============================================
    {
        ...
        definition: 'Commodity trading involves buying and selling raw materials like gold, silver, crude oil, agricultural products.',
        points: [
    ...
    },
    {
        ...
        definition: 'Gold can be invested through physical gold, gold ETFs, sovereign gold bonds, or digital gold.',
        points: [
    ...
    },
    {
        ...
        definition: 'Gold ETF is a fund that invests in physical gold and trades on stock exchanges.',
        points: [
    ...
    },
    {
        ...
        definition: 'Sovereign Gold Bonds are government securities denominated in grams of gold.',
        points: [
            'Issued by RBI',
    ...
    // =============================================
    {
        ...
        definition: 'Gilt funds invest only in government securities with no credit risk.',
        points: [
    ...
    },
    {
        ...
        definition: 'Duration measures the sensitivity of debt fund to interest rate changes.',
        points: [
    ...
    },
    {
        ...
        definition: 'XIRR calculates annualized returns for irregular cash flows like SIPs.',
        points: [
    ...
    },
    {
        ...
        definition: 'LTCG tax on equity funds: 12.5% on gains above ₹1.25 lakh per year.',
        points: [
    ...
    },
    {
        ...
        definition: 'STCG tax: 20% on equity funds held less than 1 year, as per slab for debt funds.',
        points: [
    ...
    },
    {
        ...
        definition: 'SIP amount = [Goal Amount × Expected Return Rate] / [((1 + Return Rate)^Months - 1) / Return Rate]',
        points: [
        ...
        formula: 'Monthly SIP = Goal Amount / [((1+r)^n - 1) / r], where r = monthly return, n = months',
    },
    // Continue adding more questions to reach 1000...
    // The structure remains the same for all entries
];
// Export category list
exports.knowledgeCategories1000 = [
    'Mutual Funds - Basics',
    'Mutual Funds - Types',
...
exports.knowledgeLevels1000 = ['beginner', 'intermediate', 'advanced'];
