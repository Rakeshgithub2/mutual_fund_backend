...
const fundHoldingsSchema = new mongoose_1.default.Schema({
    // Fund Identification
    schemeCode: {
        type: String,
        index: true,
...
const FundHoldings = mongoose_1.default.model('FundHoldings', fundHoldingsSchema, 'fund_holdings');
exports.default = FundHoldings;
