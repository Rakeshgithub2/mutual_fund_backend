    ...
    get collection() {
        if (!this._collection) {
            ...
            if (!db || typeof db.getCollection !== 'function') {
                throw new Error('[FundModel] MongoDB instance not initialized. Ensure mongodb.connect() was called.');
            }
            this._collection = db.getCollection('funds');
        }
