...
const mongoUrl = process.env.DATABASE_URL || 'mongodb://localhost:27017/mutual_funds_db';
async function main() {
    ...
    try {
        ...
        if (!existingAdmin) {
            ...
            console.log('✓ Admin user created: admin@mutualfunds.com (password: admin123)');
        }
        else {
            console.log('✓ Admin user already exists: admin@mutualfunds.com');
        }
        // Create sample test user
        const testUserPassword = await (0, auth_1.hashPassword)('test123');
        ...
        const funds = [
            ...
            },
            {
                ...
                benchmark: 'Nifty 50',
                expenseRatio: 0.65,
                description: 'Flagship large cap fund focusing on quality bluechip stocks',
            ...
            },
            {
                ...
                benchmark: 'Nifty 500',
                expenseRatio: 0.75,
                description: 'Multi cap fund with flexible allocation across market caps',
            ...
            },
            {
                ...
                benchmark: 'Nifty 50',
                expenseRatio: 0.7,
                description: 'Large cap fund investing in established bluechip companies',
            ...
            },
            {
                ...
                benchmark: 'Nifty 50',
                expenseRatio: 0.72,
                description: 'Well-established large cap fund with consistent track record',
        ...
        const newsArticles = [
            {
                ...
                content: 'Equity mutual funds witnessed their highest-ever monthly inflows of ₹40,608 crore in October 2025, reflecting strong investor confidence in the Indian stock market. Systematic Investment Plans (SIPs) contributed ₹23,547 crore to these inflows.',
            ...
            },
            {
                ...
                content: 'The Securities and Exchange Board of India (SEBI) has announced new guidelines aimed at enhancing transparency and investor protection in mutual fund investments. The changes include stricter disclosure norms and faster grievance redressal mechanisms.',
            ...
            },
            {
                ...
                content: 'Gold Exchange Traded Funds (ETFs) have seen a surge in demand as investors seek safe-haven assets during recent market fluctuations. Gold prices touched ₹65,000 per 10 grams, driving interest in gold-backed investment instruments.',
                source: 'Mint',
            ...
            },
            {
                ...
                content: 'Technology-focused mutual funds have delivered exceptional returns, outperforming major benchmark indices by 8-12% in the past quarter. Strong earnings from IT giants and optimistic global tech outlook fuel the rally.',
            ...
            },
            {
                ...
                content: 'Financial advisors caution investors about the volatility in small-cap mutual funds despite their attractive returns. Experts recommend limiting exposure to 15-20% of the overall equity portfolio for risk management.',
                source: 'MoneyControl',
                category: 'ANALYSIS',
            ...
            },
            {
                ...
                content: 'A comparative analysis reveals that direct mutual fund plans have saved investors up to 1.5% annually in expense ratios compared to regular plans. This difference can significantly impact long-term wealth creation.',
            ...
            },
            {
                ...
                content: 'Environmental, Social, and Governance (ESG) focused mutual funds are witnessing growing interest from millennial investors who prioritize sustainable and responsible investing alongside financial returns.',
            ...
            },
            {
                ...
                content: 'Debt mutual funds are experiencing outflows as the Reserve Bank of India maintains its hawkish stance on interest rates. Fund managers are repositioning portfolios to navigate the challenging fixed-income environment.',
                source: 'Economic Times',
            ...
            },
            {
                ...
                content: 'Financial planners advise starting tax-saving investments in ELSS (Equity Linked Savings Scheme) funds early in the financial year to benefit from rupee cost averaging and avoid the year-end rush.',
                source: 'Mint',
                category: 'TAX',
            ...
            },
            {
                ...
                content: 'Recent data shows that over 60% of actively managed large-cap funds failed to beat their benchmark indices over a 5-year period, reigniting the debate about the merits of passive investing through index funds.',
                source: 'Business Standard',
                category: 'ANALYSIS',
            ...
            },
            {
                ...
                content: 'International equity mutual funds are gaining traction as investors seek geographical diversification. Funds focused on US tech stocks and emerging markets have shown strong performance.',
                source: 'Financial Express',
            ...
            },
            {
                ...
                content: 'The Indian mutual fund industry has achieved a historic milestone with total Assets Under Management (AUM) crossing ₹50 lakh crore, driven by increasing retail participation and strong market performance.',
                source: 'MoneyControl',
                category: 'INDUSTRY',
        ...
        console.log(`📊 Total: ${fundCount} new funds, ${funds.length - fundCount} existing`);
        console.log(`📰 News: ${newsCount} new articles, ${newsArticles.length - newsCount} existing`);
        console.log('\n📝 Test Credentials:');
