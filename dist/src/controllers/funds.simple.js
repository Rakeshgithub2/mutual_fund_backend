...
const getFunds = async (req, res) => {
    try {
        ...
        if (!Fund_model_1.FundModel || typeof Fund_model_1.FundModel.getInstance !== 'function') {
            console.error('❌ FundModel is undefined - module initialization error');
            return res
                .status(500)
                .json((0, response_1.formatResponse)(null, 'Server initialization error - please try again', 500));
        }
