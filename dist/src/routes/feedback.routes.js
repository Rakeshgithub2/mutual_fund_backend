    ...
    try {
        ...
        try {
            ...
            if (!process.env.EMAIL_PASSWORD ||
                ...
                console.warn('⚠️  EMAIL_PASSWORD not configured - email will not be sent');
                console.warn('⚠️  Please create a Gmail App Password and update .env file');
                ...
                return res.status(200).json({
                    ...
                    warning: 'Email notifications are not configured. Please set up Gmail App Password.',
                });
            }
