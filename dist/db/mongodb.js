...
var DATABASE_URL = process.env.DATABASE_URL || 'mongodb://localhost:27017/mutual_funds_db';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        dbName = ((_a = DATABASE_URL.split('/').pop()) === null || _a === void 0 ? void 0 : _a.split('?')[0]) || 'mutual_funds_db';
